package com.group12.ecommerce.service.implementService.vnpay;

import com.group12.ecommerce.base.config.VNPayConfig;
...
public class VNPAYService implements IVNPAYService {
    ...
    public String createPaymentUrl(BigDecimal total, String orderInfor, String urlReturn, HttpServletRequest request) {
        ...
        vnp_Params.put("vnp_Amount", total.multiply(new BigDecimal(100)).toBigInteger().toString());
